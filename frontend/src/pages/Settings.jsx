          ...
          <div className="col-span-12 xl:col-span-3 flex flex-col gap-6">
            ...
            <div className="mt-8 bg-[#111118] border border-white/5 rounded-xl p-6 hover:border-white/10 transition-colors shadow-sm">
              ...
              <p className="text-sm text-gray-300 leading-relaxed font-medium">
                Your risk profile is currently optimized for <span className="text-white font-bold">High Volatility</span> Nifty 50 environments.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-12 xl:col-span-6 flex flex-col pl-4 pr-2">
            ...
            <div className="flex flex-col gap-10">
               ...
               <div className="flex items-center justify-end gap-8 mt-2 pt-6">
                  ...
                  <button className="bg-[#3B82F6] hover:bg-blue-500 text-white font-bold py-3.5 px-8 rounded-xl transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] hover:-translate-y-0.5 text-[15px]">Save Changes</button>
               </div>
            </div>
          </div>
